# Run modified approximate algorithm with fixed global shrinkage parameter and independence prior
#' @importFrom invgamma rinvgamma
modified_approximate_algorithm2 <- function(W, z, xi, sigma, iteration, a, b, w, t,
  ...
  for(i in 1:iteration) {
    ...
    if (i %% t == 0) {
      ...
      if (u_i < p_i)
        m_eff <- sum((1/(sigma*eta*xi/s2.vec + 1)))
